...
describe('04 - Ejercicios', () => {
  ...
  it('Dentro del React.useEffect(), se deberian setear los valores del estado local con el store de Redux', () => {
  ...
  it('Debe renderizar una etiqueta "h3" con el valor de la propiedad "email" del estado "informacion"', () => {
    ...
    expect(infoEnviada.find('h3').at(1).text()).toEqual('sarmiento@hotmail.com');
  });
  ...
  it('Debe renderizar una etiqueta "h3" con el valor de la propiedad "mensaje" del estado "informacion"', () => {
    ...
    expect(infoEnviada.find('h3').at(3).text()).toEqual('Considero que soy un persona apta para ser TA');
  });
});