...
describe('02 | Ejercicios', () => {
  it("Deberia declarar y exportar las variables ADD_PRODUCT y DELETE_PRODUCT", () => {
  ...
  it("addProduct deberia retornar un objeto con el payload y el type de la action", () => {
  ...
  it("deleteProduct deberia retornar un objeto con el payload type de la action", () => {
